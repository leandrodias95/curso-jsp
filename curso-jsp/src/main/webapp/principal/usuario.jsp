...
if (modelLogin != null && modelLogin.getSexo().equals("FEMININO")) {
	...
	out.print("");
															...
															<button type="button" class="btn btn-warning"
																data-toggle="modal" data-target="#usuarioModalBuscar">Pesquisar</button>
														</form>
													</div>
												</div>
											</div>
	...
	$("#numero, #cep").keypress(function(event){
		return /\d/.test(String.fromCharCode(event.keyCode)) //aceita só números
	})
		function limparForm() {
						...
						.ajax(
								{
									...
									success : function(response, textStatus, xhr) {
										...
										$('#tabelaresultados > tbody > tr')
												.remove(); //entra na tabela pelo id e dentro do thbody remove todas as linhas
										...
										document
												...
												+ json.length;
										var totalPagina = xhr.getResponseHeader("totalPaginaPaginacao");
	...
	<!-- Modal -->
	<div class="modal fade" id="usuarioModalBuscar" tabindex="-1"
